...
estudiantes_matematicas = {"Ana", "Luis", "Carlos", "María", "Jorge"}

# 2. Conjunto de estudiantes que cursan física (5 estudiantes)
estudiantes_fisica = {"Carlos", "María", "Sofía", "Andrés", "Lucía"}

# 3. Conjunto de estudiantes que cursan programación (5 estudiantes)
estudiantes_programacion = {"Luis", "María", "Pedro", "Camila", "Jorge"}
